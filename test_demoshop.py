...
def test_login():
    """Successful authorization to some femoshop (UI)"""
    ...
    with step("Verify succesfull authorization"):
...
def test_add_one_product_to_cart_unauthorized(demoqa_authorized_session):
